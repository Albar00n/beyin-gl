...
declare class BoxBuffer {
     ...
     */
    constructor(m_material: THREE_2.Material | THREE_2.Material[], m_renderOrder?: number, startElementCount?: number, m_maxElementCount?: number);
    /**
     ...
     */
    addBox(screenBox: Math2D.Box, uvBox: Math2D.UvBox, color: THREE_2.Color, opacity: number, distance: number, pickInfo?: any): boolean;
    /**
     ...
     */
    pickBoxes(screenPosition: THREE_2.Vector2, pickCallback: (pickData: any | undefined) => void, image?: CanvasImageSource | ImageData): void;
    /**
 ...
 */
declare class BoxBufferMesh extends THREE_2.Mesh {
    constructor(geometry: THREE_2.BufferGeometry, material: THREE_2.Material | THREE_2.Material[]);
    /**
...
export declare namespace CameraUtils {
     ...
     */
    export function getFocalLength(camera: THREE_2.PerspectiveCamera): number | undefined;
    /**
     ...
     */
    export function setFocalLength(camera: THREE_2.PerspectiveCamera, focalLength: number, viewportHeight: number): number;
    /**
     * Returns the camera's vertical field of view.
     * @param camera - The camera.
     * @returns The vertical fov in radians.
     */
    export function getVerticalFov(camera: THREE_2.PerspectiveCamera): number;
    /**
     ...
     */
    export function setVerticalFov(camera: THREE_2.PerspectiveCamera, verticalFov: number, viewportHeight: number): number;
    /**
     ...
     */
    export function convertWorldToScreenSize(focalLength: number, distance: number, worldSize: number): number;
    /**
     ...
     */
    export function convertScreenToWorldSize(focalLength: number, distance: number, screenSize: number): number;
    /**
     ...
     */
    export function getPrincipalPoint(camera: THREE_2.PerspectiveCamera, result?: Vector2Like): Vector2Like;
    /**
     ...
     */
    export function setPrincipalPoint(camera: THREE_2.PerspectiveCamera, ndcCoords: Vector2Like): void;
    /**
     * Returns the camera's horizontal field of view.
     * @param camera - The camera.
     * @returns The horizontal fov in radians.
     */
    export function getHorizontalFov(camera: THREE_2.PerspectiveCamera): number;
    /**
     ...
     */
    export function getTopFov(camera: THREE_2.PerspectiveCamera): number;
    /**
     ...
     */
    export function getBottomFov(camera: THREE_2.PerspectiveCamera): number;
    /**
     ...
     */
    export function getRightFov(camera: THREE_2.PerspectiveCamera): number;
    /**
     ...
     */
    export function getLeftFov(camera: THREE_2.PerspectiveCamera): number;
}
 ...
 * @internal
 */
export declare function computeArrayStats(samples: number[]): Stats_2 | undefined;
 ...
 * @internal
 */
export declare function createMaterial(rendererCapabilities: THREE_2.WebGLCapabilities, options: MaterialOptions, onTextureCreated?: (texture: Promise<THREE_2.Texture>) => void): THREE_2.Material | undefined;
 ...
 */
export declare abstract class DataProvider extends EventDispatcher_2 {
...
export declare class DebugTile extends Tile {
    ...
    private readonly m_textRenderStyle;
    private readonly m_textLayoutStyle;
    constructor(dataSource: DataSource, tileKey: TileKey, gridColor?: string);
}
...
export declare interface ElevationProvider {
     ...
     */
    rayCast(x: number, y: number): THREE_2.Vector3 | undefined;
    /**
...
export declare class EventDispatcher {
     ...
     */
    hasEventListener(type: string, listener?: (event: THREE_2.Event) => void): boolean;
    /**
     ...
     */
    listeners(type: string): Array<(event: THREE_2.Event) => void> | undefined;
    /**
     * Dispatch the event to the registered listeners.
     *
     * @param event - The event to dispatch.
     */
    dispatchEvent(event: THREE_2.Event): void;
}
 ...
 */
export declare interface FeatureDataSourceOptions extends VectorTileDataSourceParameters, GeoJsonDataProviderOptions {
    /**
...
declare class FrustumIntersection {
    ...
    constructor(m_camera: THREE_2.PerspectiveCamera, mapView: MapView, m_extendedFrustumCulling: boolean, m_tileWrappingEnabled: boolean, m_enableMixedLod: boolean, m_tilePixelSize?: number);
    /**
 ...
 * @beta, @internal
 */
export declare interface GeoPolygonLike {
    /**
...
declare class GlyphData {
     ...
     */
    constructor(codePoint: number, block: string, width: number, height: number, advanceX: number, offsetX: number, offsetY: number, u0: number, v0: number, u1: number, v1: number, texture: THREE_2.Texture, font: Font, isReplacement?: boolean);
    /**
...
export declare class HereTileProvider implements WebTileDataProvider {
    ...
    private readonly m_copyrightProvider;
    private readonly m_ppi;
    private readonly m_resolution;
    private readonly m_tileBaseAddress;
    private m_languages?;
 ...
 */
export declare class HereWebTileDataSource extends WebTileDataSource {
    /**
 ...
 */
declare interface HereWebTileDataSourceOptions extends Omit<WebTileDataSourceOptions, "dataProvider"> {
    /**
     * Base URL.
     *
     * @remarks
 ...
 */
export declare type HereWebTileDataSourceParameters = HereWebTileDataSourceOptions & (ApiKeyAuthentication | AppIdAuthentication | TokenAuthentication);
 ...
 */
declare interface IntersectParams {
    /**
 ...
 * @internal
 */
export declare function isDepthPrePassMesh(object: THREE_2.Object3D): boolean;
 ...
 * @beta, @internal
 */
export declare function isGeoPolygonLike(object: any): object is GeoPolygonLike;
...
export declare function isVector2Like(v: any): v is Vector2Like;
...
export declare class MapAnchors {
     ...
     * @hidden
     */
    update(projection: Projection, cameraPosition: THREE_2.Vector3, rootNode: THREE_2.Object3D, overlayRootNode: THREE_2.Object3D): void;
}
...
export declare class MapView extends EventDispatcher {
     ...
     */
    get overlayScene(): THREE_2.Scene;
    /**
     ...
     */
    get worldMaxBounds(): THREE_2.Box3 | OrientedBox3 | undefined;
    /**
     ...
     * `undefined`.
     */
    getScreenPosition(pos: GeoCoordLike | THREE_2.Vector3): THREE_2.Vector2 | undefined;
    getWorldPositionAt(x: number, y: number, fallback: true): THREE_2.Vector3;
    getWorldPositionAt(x: number, y: number, fallback?: boolean): THREE_2.Vector3 | null;
    /**
     ...
     */
    ndcToView(vector: Vector3Like, result: THREE_2.Vector3): THREE_2.Vector3;
    /**
...
export declare class MapViewAtmosphere {
     ...
     */
    constructor(m_mapAnchors: MapAnchors, m_sceneCamera: THREE_2.Camera, m_projection: Projection, m_rendererCapabilities: THREE_2.WebGLCapabilities, m_updateCallback?: (() => void) | undefined, m_atmosphereVariant?: AtmosphereVariant, m_materialVariant?: AtmosphereShadingVariant);
...
export declare namespace MapViewUtils {
     ...
     */
    export function zoomOnTargetPosition(mapView: MapView, targetNDCx: number, targetNDCy: number, zoomLevel: number, maxTiltAngle?: number): boolean;
    /**
     ...
     */
    export function orbitAroundScreenPoint(mapView: MapView, offsetX: number, offsetY: number, deltaAzimuth: number, deltaTilt: number, maxTiltAngle: number): void;
    /**
     * Orbits the camera around a given point on the screen.
     *
     * @param mapView - The {@link MapView} instance to manipulate.
     ...
     */
    export function constrainTargetAndDistanceToViewBounds(target: THREE_2.Vector3, distance: number, mapView: MapView): {
     ...
     */
    export function rayCastWorldCoordinates(mapView: MapView | {
        camera: THREE_2.Camera;
        projection: Projection;
    }, pointOnScreenXinNDC: number, pointOnScreenYinNDC: number, elevation?: number): THREE_2.Vector3 | null;
    /**
     ...
     */
    export function rotate(mapView: {
        projection: Projection;
        camera: THREE_2.PerspectiveCamera;
     ...
     */
    export function extractAttitude(mapView: {
        projection: Projection;
     ...
     */
    export function extractSphericalCoordinatesFromLocation(mapView: {
        projection: Projection;
    }, object: THREE_2.Object3D, location: GeoCoordinatesLike | Vector3Like): {
        azimuth: number;
        tilt: number;
    };
    /**
     ...
     * the given angle.
     */
    export function extractTiltAngleFromLocation(projection: Projection, object: THREE_2.Object3D, location: GeoCoordinates | Vector3Like, tiltAxis?: THREE_2.Vector3): number;
    /**
     ...
     * @param options - Subset of necessary {@link MapView} properties.
     */
    export function calculateDistanceToGroundFromZoomLevel(mapView: {
        projection: Projection;
        focalLength: number;
        camera: THREE_2.PerspectiveCamera;
    ...
    export function closeToFrustum(point: THREE_2.Vector3, camera: THREE_2.Camera, eps?: number): boolean;
    /**
 ...
 * @internal
 */
export declare type MaterialConstructor = new (params: any) => THREE_2.Material;
...
declare namespace Object3DUtils {
     ...
     */
    function estimateSize(object: THREE_2.Object3D, parentSize?: MemoryUsage, visitedObjects?: Map<string, boolean>): MemoryUsage;
}
 ...
 *   ```
 */
export declare class OmvDataSource extends VectorTileDataSource {
}
 ...
 *             instad.
 */
export declare type OmvDataSourceParameters = VectorTileDataSourceParameters;

export declare class OmvDebugLabelsTile extends Tile {
    constructor(dataSource: DataSource, tileKey: TileKey);
    /**
     * @override
...
declare class PickingRaycaster extends THREE_2.Raycaster {
    readonly canvasSize: THREE_2.Vector2;
    /**
     * Constructor.
     *
     * @param canvasSize - the canvas width and height.
     */
    constructor(canvasSize: THREE_2.Vector2);
    intersectObject(object: THREE_2.Object3D, recursive?: boolean, optionalTarget?: THREE_2.Intersection[]): THREE_2.Intersection[];
    intersectObjects(objects: THREE_2.Object3D[], recursive?: boolean, optionalTarget?: THREE_2.Intersection[]): THREE_2.Intersection[];
}
 ...
 */
export declare interface PoiGeometry extends TextGeometry {
    /**
...
declare class PoiRenderer {
     ...
     */
    constructor(m_renderer: THREE_2.WebGLRenderer, m_poiManager: PoiManager, m_imageCaches: MapViewImageCache[]);
    get renderer(): THREE_2.WebGLRenderer;
    /**
     ...
     */
    addPoi(poiInfo: PoiInfo, screenPosition: THREE_2.Vector2, screenCollisions: ScreenCollisions, viewDistance: number, scale: number, allocateScreenSpace: boolean, opacity: number, env: Env): void;
    /**
     ...
     */
    render(camera: THREE_2.OrthographicCamera, layer: PoiLayer): void;
    /**
     * Fill the picking results for the pixel with the given screen coordinate. If multiple
 ...
 */
declare interface ReferenceResolverState {
    definitions: Definitions;
...
declare class ScreenProjector {
     ...
     */
    projectToScreen(source: Vector3Like, target?: THREE_2.Vector2): THREE_2.Vector2 | undefined;
    /**
     ...
     */
    projectAreaToScreen(source: Vector3Like, halfWidth: number, halfHeight: number, target?: THREE_2.Vector2): THREE_2.Vector2 | undefined;
    /**
     * Apply current projectionViewMatrix of the camera to project the source vector into
...
export declare interface SimpleFrameStatistics {
    ...
    frameStats?: Map<string, Stats_2 | undefined>;
 ...
 */
export declare interface StyleAttributes<Technique, Params> {
    /**
...
declare interface TaskQueueOptions {
    /**
...
declare class TextCanvas {
     ...
     */
    render(camera: THREE_2.OrthographicCamera, lowerLayerId?: number, higherLayerId?: number, target?: THREE_2.WebGLRenderTarget, clear?: boolean): void;
    /**
...
export declare class TextElementsRenderer {
     ...
     */
    constructor(m_viewState: ViewState, m_screenProjector: ScreenProjector, m_poiManager: PoiManager, m_renderer: THREE_2.WebGLRenderer, m_imageCaches: MapViewImageCache[], options: TextElementsRendererOptions, textCanvasFactory?: TextCanvasFactory, poiRenderer?: PoiRenderer, screenCollisions?: ScreenCollisions);
    /**
     * Disable all fading animations (for debugging and performance measurement). Defaults to
     * `false`.
     */
    ...
    restoreRenderers(renderer: THREE_2.WebGLRenderer): void;
    /**
     ...
     */
    pickTextElements(screenPosition: THREE_2.Vector2, pickListener: PickListener): void;
    /**
...
export declare class TextureLoader {
     ...
     */
    load(url: string, requestHeaders?: RequestHeaders | undefined, abortSignal?: AbortSignal, crossOrigin?: boolean): Promise<THREE_2.Texture>;
...
export declare namespace TileKeyUtils {
    export function geoCoordinatesToTileKey(tilingScheme: TilingScheme, geoPoint: GeoCoordinatesLike, level: number): TileKey | null;
    export function worldCoordinatesToTileKey(tilingScheme: TilingScheme, worldPoint: Vector3Like, level: number): TileKey | null;
    export function geoRectangleToTileKeys(tilingScheme: TilingScheme, geoBox: GeoBox, level: number): TileKey[];
    /**
...
export declare class TiltViewClipPlanesEvaluator extends TopViewClipPlanesEvaluator {
    ...
    /** @override */
    protected evaluateDistancePlanarProj(camera: THREE_2.PerspectiveCamera, projection: Projection, elevationProvider?: ElevationProvider): ViewRanges;
    /** @override */
    protected evaluateDistanceSphericalProj(camera: THREE_2.PerspectiveCamera, projection: Projection, elevationProvider?: ElevationProvider): ViewRanges;
...
export declare interface VectorTileDataSourceParameters extends DataSourceOptions, Omit<TileDataSourceOptions, "dataProvider" | "tilingScheme"> {
    /**
...
export declare interface VectorTileFactory {
 ...
 * @deprecated
 */
export declare interface VerboseDefinition {
    /**
...
export declare interface WebTileDataProvider {
    /**
     ...
     * @param abortSignal - Optional AbortSignal to cancel the request.
     */
    getTexture: (tile: Tile, abortSignal?: AbortSignal) => Promise<[THREE_3.Texture | undefined, CopyrightInfo[]] | undefined>;
}
 ...
 */
export declare interface WebTileDataSourceOptions extends Omit<DataSourceOptions, "enablePicking" | "styleSetName"> {
    /**
