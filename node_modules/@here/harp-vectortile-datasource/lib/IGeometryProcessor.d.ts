...
export interface IGeometryProcessor {
     ...
     */
    processPointFeature(layerName: string, tileExtents: number, geometry: Vector3[], properties: ValueMap, featureId: string | number | undefined): void;
    /**
     ...
     * @param featureId - The feature identifier.
     */
    processLineFeature(layerName: string, tileExtents: number, geometry: ILineGeometry[], properties: ValueMap, featureId: string | number | undefined): void;
    /**
     ...
     * @param featureId - The feature identifier.
     */
    processPolygonFeature(layerName: string, tileExtents: number, geometry: IPolygonGeometry[], properties: ValueMap, featureId: string | number | undefined): void;
}
